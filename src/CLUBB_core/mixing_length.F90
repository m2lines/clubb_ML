...
module mixing_length
  ...
  subroutine compute_mixing_length( nzm, nzt, ngrdcol, gr, thvm, thlm, &
    ...
    !--------------------------------- FTorch Variables ---------------------------------
    real( kind = core_rknd ), dimension(4) :: ftorch_array_1, ftorch_array_2, ftorch_array_out
    ...
    write(unit=fstdout,fmt='(f8.2, f8.2, f8.2, f8.2)') ftorch_array_out(1), ftorch_array_out(2), ftorch_array_out(3), ftorch_array_out(4)
